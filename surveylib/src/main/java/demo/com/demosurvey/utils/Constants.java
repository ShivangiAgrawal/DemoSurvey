...
public class Constants {
    ...
    public static final String CIRCULAR_SLIDER = "CIRCULAR_SLIDER";
    public static final String VIEW_RECTANGLE_SELECTION = "VIEW_RECTANGLE_SELECTION";
    public static final String NEXT = "NEXT";
    public static final String DONE = "DONE";
    public static final String LEAST_APPEALING = "Least Appealing" ;
    public static final String MOST_APPEALING = "Most Appealing" ;
